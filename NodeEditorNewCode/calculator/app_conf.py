...
class OpCodeNotRegistered (Exception):pass


def register_node_now(op_code, class_reference):
    if op_code in CALC_NODES:
        raise InvalidNodeRegistration("Duplicate node registration of '%s'. there is already %s " % (op_code,CALC_NODES[op_code]))
...
from NodeEditorNewCode.calculator.nodes import *